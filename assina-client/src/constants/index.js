...
export const ASSINA_RSSP_BASE_URL = process.env.REACT_APP_ASSINA_RSSP_BASE_URL || 'http://localhost:8082';
export const ASSINA_SA_BASE_URL = process.env.REACT_APP_ASSINA_SA_BASE_URL || 'http://localhost:8083';
