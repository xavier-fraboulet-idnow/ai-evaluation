...
/**
 * Body for response of credentials/authorize - provides the client the SAD
 * token needed to
...
public class CSCCredentialsAuthorizeResponse {
    ...
    // REQUIRED
    // The Signature Activation Data (SAD) to be used as input to the
    // signatures/signHash method,
    // as defined in section 11.9.
    private String SAD;

    // OPTIONAL
    // The lifetime in seconds of the SAD. If omitted, the default expiration time
    // is 3600 (1 hour).
